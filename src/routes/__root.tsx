...
import { ThemeProvider } from "@/components/lifeos/theme";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-lg text-foreground">This page isn't part of your system</h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "LifeOS — your personal operating system" },
      {
        name: "description",
        content:
          "LifeOS is a calm personal operating system for habits, tasks, goals and weekly reviews.",
      },
      { property: "og:title", content: "LifeOS — your personal operating system" },
      {
        property: "og:description",
        content: "Habits, tasks, goals and weekly reviews in one quiet, dark-first workspace.",
      },
